...
using ControllerContext = SolaceTK.Data.Contexts.ControllerContext;
...
namespace SolaceTK.Core.Controllers.Health
{
    ...
    public class HealthController : ControllerBase
    {
        ...
        ControllerContext controllerContext, EnvironmentContext envContext,
        ...
        private async Task<List<string>> CheckAseprite()
        {
            ...
            var asePresent = AsepriteService.CheckAse();
